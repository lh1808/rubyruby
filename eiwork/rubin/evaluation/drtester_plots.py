...
werden die funktionierenden Teile trotzdem korrekt gespeichert."""
    ...
    def summary(self, *, tmt=0):
        ...
        Die EconML-Basisklasse crasht, wenn einzelne Sub-Results None sind.
        Diese Überschreibung baut eine partielle Summary zusammen."""
        rows = []
...
def filter_tester_for_mask(
    ...
    Wird bei Train-Many-Evaluate-One benötigt. Returns None bei Fehler."""
    try:
        ft = CustomDRTester(
