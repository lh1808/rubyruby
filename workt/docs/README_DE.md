...
- **Analyse-Pipeline**: Trainieren, Feature-Selektion (Korrelation + Importance-Union mit Umverteilung), Tuning (BL + FMT mit Stability Penalty), Evaluieren, Surrogate-Einzelbaum (Champion), Explainability (SHAP/Permutation + Segmentanalyse), HTML-Report mit klickbaren Plots (Lightbox).
