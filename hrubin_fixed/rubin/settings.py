...
class DataFilesConfig(BaseModel):
    ...
    # Eval-Maske für "Train Many, Evaluate One" (optional).
    # Boolean-Array (.npy): True = Zeile wird für Evaluation verwendet.
    # Alle Zeilen werden für Training/Cross-Prediction genutzt, aber
    # Uplift-Metriken und DRTester-Plots nur auf Masken-Zeilen berechnet.
...
class DataPrepConfig(BaseModel):
    ...
    # "Train Many, Evaluate One": Index der Datei (0-basiert), deren Daten für
    # die Evaluation verwendet werden sollen. Alle Dateien werden für Training
    # und Cross-Prediction genutzt, aber Metriken nur auf dieser Datei berechnet.
    eval_file_index: Optional[int] = None
